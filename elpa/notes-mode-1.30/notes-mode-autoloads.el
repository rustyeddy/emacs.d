...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "notes-aux" '("notes-file-to-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "notes-emacs" '("notes-platform-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "notes-first" '("notes-first-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "notes-index-mode" '("notes-index-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "notes-mode" '("notes-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "notes-url" '("notes-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "notes-variables" '("notes-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "notes-xemacs" '("notes-platform-")))
